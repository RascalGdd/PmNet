...
**Note:** The **PmLR50 dataset** is released under a separate license for **non-commercial academic research and educational purposes only**. Redistribution and public release of modified or derivative versions of the dataset are prohibited without prior written permission. Please refer to the [PmLR50 Dataset License](DATASET_LICENSE.md) for the complete terms and conditions.
